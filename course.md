...
- Code analysis:
  ...
  - **buttonState = digitalRead(buttonPin);**<br>This function is used to read the states of digital pins, either HIGH or LOW. When the button is pressed, the state is HIGH, otherwise is lOW.
